...
<input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="40" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> /></p>

<p><label for="email">Email <?php if ($req) echo "(required)"; ?> (will not be published)</label><br />
<input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="40" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> /></p>
...
<p><strong><?php _e("If you want a picture to show with your comment, go get a"); ?> <a href="http://en.gravatar.com/">Gravatar</a></strong>.</p>
