...
<?php if ( $wp_chatter_feature_display == 'Display Separately') { ?>
<?php include (TEMPLATEPATH . '/features2.php'); ?>
<?php } else { ?>
...
<?php $count = 1 ?>
<?php $featurecount = $wp_chatter_features_number; 
...
<?php if ( $wp_chatter_features_auto_glide == no ) { ?>
