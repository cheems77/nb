...
$do_not_duplicate[$post->ID] = $post->ID; ?>
						<li class="homepost clearfix maincontent" id="post-1-<?php the_ID(); ?>">
...
<?php while (have_posts()) : the_post(); 
$do_not_duplicate[$post->ID] = $post->ID; ?>
						<li class="homepost clearfix maincontent" id="post-3-<?php the_ID(); ?>">
							<div class="entry clearfix">
								<a href="<?php the_permalink() ?>" rel="<?php _e("bookmark"); ?>" title="<?php _e("Permanent Link to"); ?> <?php the_title(); ?>"><?php include (TEMPLATEPATH . '/post-thumb.php'); ?></a>
								<h3><a href="<?php the_permalink() ?>" rel="<?php _e("bookmark"); ?>" title="<?php _e("Permanent Link to"); ?> <?php the_title(); ?>"><?php the_title(); ?></a></h3>
								<?php the_excerpt(); ?>
...
<?php while (have_posts()) : the_post(); 
$do_not_duplicate[$post->ID] = $post->ID; ?>
						<li class="homepost clearfix maincontent" id="post-2-<?php the_ID(); ?>">
							<div class="entry clearfix">
								<a href="<?php the_permalink() ?>" rel="<?php _e("bookmark"); ?>" title="<?php _e("Permanent Link to"); ?> <?php the_title(); ?>"><?php include (TEMPLATEPATH . '/post-thumb.php'); ?></a>
								<h3><a href="<?php the_permalink() ?>" rel="<?php _e("bookmark"); ?>" title="<?php _e("Permanent Link to"); ?> <?php the_title(); ?>"><?php the_title(); ?></a></h3>
								<?php the_excerpt(); ?>
...
<?php endwhile; ?>
					...
					<?php } ?>
						<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('Sidebar - Column 2') ) : ?>
						<?php endif; ?>
...
<?php while (have_posts()) : the_post(); 
$do_not_duplicate[$post->ID] = $post->ID; ?>
						<li class="homepost clearfix maincontent" id="post-4-<?php the_ID(); ?>">
							<div class="entry clearfix">
								<a href="<?php the_permalink() ?>" rel="<?php _e("bookmark"); ?>" title="<?php _e("Permanent Link to"); ?> <?php the_title(); ?>"><?php include (TEMPLATEPATH . '/post-thumb.php'); ?></a>
								<h3><a href="<?php the_permalink() ?>" rel="<?php _e("bookmark"); ?>" title="<?php _e("Permanent Link to"); ?> <?php the_title(); ?>"><?php the_title(); ?></a></h3>
								<?php the_excerpt(); ?>
...
<?php endwhile; ?>
						<li class="bottom">
							<a href="<?php bloginfo('url'); ?>/category/<?php echo $wp_chatter_cat_box_4; ?>/"><?php _e("More rom"); ?> <?php echo $wp_chatter_cat_box_4_title; ?></a>
						</li>
					</ul>
					<?php } ?>
...
if ( $post->ID == $do_not_duplicate[$post->ID] ) continue; ?>
					<li class="homepost clearfix maincontent" id="post-main-<?php the_ID(); ?>">
						<div class="entry clearfix">
							<a href="<?php the_permalink() ?>" rel="<?php _e("bookmark"); ?>" title="<?php _e("Permanent Link to"); ?> <?php the_title(); ?>"><?php include (TEMPLATEPATH . '/post-thumb.php'); ?></a>
							<h3><a href="<?php the_permalink() ?>" rel="<?php _e("bookmark"); ?>" title="<?php _e("Permanent Link to"); ?> <?php the_title(); ?>"><?php the_title(); ?></a></h3>
							<?php the_excerpt(); ?>
