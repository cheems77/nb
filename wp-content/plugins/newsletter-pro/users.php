...
if ($action == 'feed_all') {
    $wpdb->query("update " . $wpdb->prefix . 'newsletter set feed=1');
}
...
<div class="wrap">
    ...
    <p>From this panel you can manage your subscribers editing and deleting them. You can access the subscribers' statistics page too. Be aware that
    subscribers have nothing to do with WordPress users.</p>

    <h3>Statistics</h3>
    <p><a href="admin.php?page=newsletter-pro/users-stats.php">See statistic data and graphs</a></p>
        ...
        <table class="form-table">
            <tr valign="top">
                <td>
                    ...
                    <?php $nc->select('search_status', array(''=>'Any status', 'C'=>'Confirmed', 'S'=>'Not confirmed')); ?>
